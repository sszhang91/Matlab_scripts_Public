function [im_data, x, y] = sp_load_file_for_script(folder, filebasename, suffix)
...
xeidx=strfind(line12, '=');
xext=str2num(line12(xeidx+1:end));

% find y extent in image
line13 = fgets(file_ID);
yeidx=strfind(line13, '=');
yext=str2num(line13(xeidx+1:end));
...
%line13 = fgets(file_ID);
line14 = fgets(file_ID); line15 = fgets(file_ID);
line16 = fgets(file_ID); line17 = fgets(file_ID);
