function [im_data, x, y] = sp_load_file_for_script_n7(folder, filebasename, suffix)

filepath = strcat(folder, "\", filebasename, " ", suffix, " raw.gsf");
% disp(filepath)
%filepath="D:\BASOV\TaS2\2020 12 07\2020-12-07 170417 PH 201207 TaS2 gr (2) 960 cm-1.gsf"
...
% lines 4-10 give Neaspec info and x and y offsets, which we will not use.
